...
namespace Vsite.Oom.Battleship.Model
{
    public class Grid
    {
        ...
        private List<IEnumerable<Square>> GetHorizontalPlacements(int shipLength)
        {
                ...
                for(int c = 0; c < Columns; ++c)
                {
                    if (squares[r, c] != null)
                    {
                        ...
                        if (count >= shipLength)
                        {
                            ...
                            for (int c1 = c - shipLength + 1; c1 <= c; ++c1)
        ...
        private List<IEnumerable<Square>> GetVerticalPlacements(int shipLength)
        {
            List<IEnumerable<Square>> result = new List<IEnumerable<Square>>();
            for (int c = 0; c < Columns; ++c)
            {
                ...
                for (int r = 0; r < Rows; ++r)
                {
                    if (squares[r, c] != null)
                    {
                        ...
                        {
                            List<Square> arr = new List<Square>();
                            for (int r1 = r - shipLength + 1; r1 <= r; ++r1)
