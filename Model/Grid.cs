...
namespace Vsite.Oom.Battleship.Model
{
    public class Grid
    {
        ...
        private List<IEnumerable<Square>> GetHorizontalPlacements(int lenght)
        {
        ...
        private List<IEnumerable<Square>> GetVerticalPlacements(int lenght)
        {
            List<IEnumerable<Square>> result = new List<IEnumerable<Square>>();
            for (int c = 0; c < Columns; ++c)
            {
