...
namespace Vsite.Oom.Battleship.Model
{
    public class Grid
    {
        ...
        public IEnumerable<IEnumerable<Square>> GetAvailablePlacements(int shipLenght)
        {
            List<IEnumerable<Square>> list = GetHorizontalPlacements(shipLenght);
            list.AddRange(GetVerticalPlacements(shipLenght));
            return list;
        }
