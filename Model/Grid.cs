...
namespace Vsite.Oom.Battleship.Model
{
    public class Grid
    {
        ...
        public IEnumerable <IEnumerable<Square>> GetAvailablePlacements (int shipLength) {
            ...
            List<IEnumerable<Square>> list = GetHorizontalPlacement(shipLength);
            list.AddRange(GetVerticalPlacement(shipLength));
            return list;
        ...
        private List<IEnumerable<Square>> GetHorizontalPlacement(int length)
        { 
        ...
        private List<IEnumerable<Square>> GetVerticalPlacement(int length)
        {
