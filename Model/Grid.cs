...
namespace Vsite.Oom.Battleship.Model
{
    public class Grid
    {
        ...
        public IEnumerable<IEnumerable<Square>> GetAvailablePlacements(int shipLength)
        {
            ...
            List<IEnumerable<Square>> list = GetHorizontalPlasments(shipLength);
            list.AddRange(GetVerticalPlasments(shipLength));
            return list;
        }
        ...
        private List<IEnumerable<Square>> GetHorizontalPlasments(int length)
        {
        ...
        private List<IEnumerable<Square>> GetVerticalPlasments(int length)
        {
            List<IEnumerable<Square>> result = new List<IEnumerable<Square>>();
